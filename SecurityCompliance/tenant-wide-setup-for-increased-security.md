...
|***Email Authentication*** <br/> |Yes  <br/> |Email authentication uses a Domain Name System (DNS) to add verifiable information to email messages about the sender of an email. Office 365 sets up email authentication for its default domain (onmicrosoft.com), but Office 365 admins can also use email authentication for custom domains. <br/> <br> Three authentication methods are used: </br> <br> •   Sender Policy Framework (or SPF) validates email by verifying the IP address of the sender against the alleged owner of the sending domain. See [Set up SPF in Office 365 to help prevent spoofing](set-up-spf-in-office-365-to-help-prevent-spoofing.md)- What to watch out for: Non-standard deployments, hybrid deployments, because you may need a deeper understanding: [How Office 365 uses Sender Policy Framework (SPF) to prevent spoofing](how-office-365-uses-spf-to-prevent-spoofing.md). <br/><br> •   DomainKeys Identified Mail (DKIM) lets you attach a digital signature to the message header of emails you send. Email systems that get email from your domain use this digital signature to figure out if incoming email is legitimate. See [Use DKIM to validate outbound email sent from your custom domain in Office 365](https://docs.microsoft.com/office365/SecurityCompliance/use-dkim-to-validate-outbound-email).  <p/>&ensp;&ensp;&ensp;&ensp;&ensp;- After you've configured DKIM, you can enable it for your organization in the Security &amp; Compliance Center.<br/><br> •   Domain-based Message Authentication, Reporting, and Conformance (DMARC) helps receiving mail systems figure out what to do with messages that fail SPF or DKIM checks. It provides another level of trust for your email partners. For information on setting up DMARC, see [Use DMARC to validate email in Office 365](use-dmarc-to-validate-email.md).<br/>  <br/>

<br> [!NOTE]
> After you've configured DKIM, you can enable it for your organization in the Security &amp; Compliance Center.<br/> 
|
