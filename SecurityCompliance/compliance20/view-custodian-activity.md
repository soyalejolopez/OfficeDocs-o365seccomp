...
## Step 1: Create an Advanced eDiscovery (Preview) audit log search
   ...
   4. Configure the following search criteria:
      ...
      ![List of Activities][../media/CustodianAuditActivity.png]
    ...
    1. Click  ![Search Button][../media/SearchButton.PNG]  to run the search using your search criteria. The search results are loaded, and after a few moments they are displayed under Results on the Custodian Activities search page. 
