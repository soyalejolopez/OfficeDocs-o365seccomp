...
## [eDiscovery 2.0 in Microsoft 365](overview-ediscovery-20.md)
### [Using eDiscovery 2.0 for litigation](ediscovery-for-litigation-workflow.md)
### [Using eDiscovery 2.0 for investigations](ediscovery-for-investigations-workflow.md)
### [User role matrix](ediscovery-user-role-matrix.md)
### [Create a new case](create-new-ediscovery-case.md)
## [Managing custodians](managing-custodians.md)
### [Add custodians to a case](add-custodians-to-case.md)
### [Manage new custodians](manage-new-custodians.md)
### [View custodian activity](view-custodian-activity.md)
### [Manage existing custodians](manage-existing-custodians.md)
## Managing holds](managing-holds.md)
### [View all holds in a case](view-all-holds.md)
### [Manage custodial holds](manage-custodial-holds.md)
### [Manage non-custodial holds](manage-non-custodial-holds.md)
## [Managing custodian communications](managing-custodian-communications.md)
### [Create a hold notification](create-hold-notification.md)
### [Using the communications editor](using-communications-editor.md)
### [Manage hold notifications](manage-hold-notification.md)
### [Add custodians to a hold notification](add-custodians-to-hold-notification.md)
### [Edit a hold notification](edit-hold-notification.md)
### [Acknowledging a hold notification](acknowledge-hold-notification.md)
## [Processing data for a case](processing-data-for-case.md)
### [Indexing of custodian data](indexing-custodian-data.md)
### [Types of processing errors](processing-error-types.md)
### [Error remediation when processing data](error-remediation.md)
## [Collecting data for a case](collecting-data-for-ediscovery.md)
### [Create a search to collect data](create-search-to-collect-data.md)
### [Building search queries](building-search-queries.md)
### [Search statistics](search-statistics.md)
### [Add data to a working set](add-data-to-working-set.md)
## [Managing working sets](managing-working-sets.md)
### [Manage load sets](manage-load-sets.md)
### [Load non-Office 365 data into a working set](load-non-office365-data.md)
## [Reviewing data in a working set](reviewing-data-in-working-set.md)
### [Working set search](working-set-search.md)
### [Tagging documents in a working set](tagging-documents.md)
### [Annotating and redacting documents in a working set](annotating-and-redacting-documents.md)
## [Analyzing data in a working set](analyzing-data-in-working-set.md)
### [Near duplicates](near-duplicates.md)
### [Email threading](email-threading.md)
### [Themes](themes.md)
## [Using the Relevance module to analyze data](using-relevance.md)
## [Exporting data](exporting-data-ediscover20.md)
### [Export documents from a working set](export-documents-from-working-set.md)
### [Download export jobs](download-export-jobs.md)
## [Managing jobs](managing-jobs-ediscovery20.md)
## [Configuring case settings](configuring-case-settings-ediscovery20.md)
### [Close or delete a case](close-or-delete-case.md)
### [Add or remove members from a case](add-remove-members.md)
### [Configure search and analytics settings](configure-search-analytics-settings.md)
## [eDiscovery 2.0 Reference]
### [Search limits](search-limits-ediscovery20.md)
### [Indexing limits](indexing-limits-ediscovery20.md)
### [Export limits](export-limits-ediscovery20.md)
### [Download limits](download-limits-ediscovery20.md)
